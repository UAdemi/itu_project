...
biden_tw <- read.csv("~/Desktop/İTÜ Big Data Grup /Bitirme Projesi /archive/JoeBidenTweets.csv", stringsAsFactors = FALSE)
View(biden_tw)

trump_tw <- read.csv("~/Desktop/İTÜ Big Data Grup /Bitirme Projesi /archive/realdonaldtrump.csv", stringsAsFactors = FALSE)
trump_tw1 <- read.csv("~/Desktop/İTÜ Big Data Grup /Bitirme Projesi /archive/trumptweets.csv", stringsAsFactors = FALSE)
```
